...
TEST_F(VertexTest, checkInnerAngleBetweenToVectors_ExpectRightAngle){
...
TEST_F(VertexTest, checkInnerAngleBetweenSameVectors_ExpectNull){
    Vertex v1 = Vertex(1.0, 4.0, -2.0);
...
TEST_F(VertexTest, checkInnerAngleBetweenNullVectors_ExpectNull){
    Vertex v1 = Vertex(0.0, 0.0, 0.0);
    Vertex v2 = Vertex(0.0, 0.0, 0.0);
...
TEST_F(VertexTest, checkInnerAngleBetweenSecondNullVectors_ExpectNull){
...
TEST_F(VertexTest, checkInnerAngleBetweenFirstNullVectors_ExpectNull){
    Vertex v1 = Vertex(0.0, 0.0, 0.0);
