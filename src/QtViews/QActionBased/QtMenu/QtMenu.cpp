...
void QtMenu::addQAction(QActionBasedPtr qActionBased) {
    if(menuContainsEmptyAction())
        removeEmptyActionFromMenu();

    addToMenu(qActionBased->getQAction());
}
void QtMenu::removeQAction(QActionBasedPtr qActionBased) {
    removeFromMenu(qActionBased->getQAction());
